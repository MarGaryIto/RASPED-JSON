...
$sql = "select P.id_personal, A.id_asistencias, P.nombre_personal, P.apellido_m,
P.apellido_p, F.fecha, A.hr_entrada, A.hr_comida_i, A.hr_comida_f, A.hr_salida
from personal P, asistencias A, fechas F
where A.fk_personal = P.id_personal and
A.fk_fecha = F.id_fecha;";
