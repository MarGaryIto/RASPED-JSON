...
$sql = "select P.id_personal, R.id_retardos, P.nombre_personal, P.apellido_m,
P.apellido_p, F.fecha, R.hr_entrada, R.hr_comida_i, R.hr_comida_f, R.hr_salida
from personal P, retardos R, fechas F
where R.fk_personal = P.id_personal and
R.fk_fecha = F.id_fecha;";
...
while($row = mysqli_fetch_array($result)) { 
    ...
    $clientes[] = array('id_personal'=> $id_personal, 'id_retardos'=> $id_retardos, 'nombre_personal'=> $nombre_personal, 'apellido_m'=> $apellido_m, 'apellido_p'=> $apellido_p,
